      ...
      if (session != null) {
         ...
         final String bodyTemplate =
               StringUtils.isNotEmpty(locale) && "cs".equals(locale)
                     ? "Dobrý den,<br/><br/>Váš kolega %s Vás zve ke spolupráci do Lumeera<br/><a href=\"https://get.lumeer.io/cs/\">get.lumeer.io</a><br/><br/>Hezký den,<br/>Tým Lumeer<br/>"
                     : "Hello,<br/><br/>your colleague %s has invited you to collaborate in Lumeer<br/><a href=\"https://get.lumeer.io/en/\">get.lumeer.io</a><br/><br/>Cheers,<br/>Lumeer Team<br/>";
