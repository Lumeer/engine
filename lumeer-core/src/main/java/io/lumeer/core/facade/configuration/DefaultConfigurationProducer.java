...
public class DefaultConfigurationProducer implements Serializable {
   ...
   public static final String MAILERLITE_NEWSLETTER_CS = "mailerlite_newsletter_cs";
   public static final String MAILERLITE_NEWSLETTER_EN = "mailerlite_newsletter_en";
