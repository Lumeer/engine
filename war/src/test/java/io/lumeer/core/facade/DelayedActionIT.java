...
public class DelayedActionIT extends IntegrationTestBase {
   ...
   public void configureCollection() {
      ...
      jsonCollection.setAttributes(List.of(
            new Attribute("a0", "Summary", null, new Constraint(ConstraintType.Text, null), null, null, null, 0, null),
            new Attribute("a1", "Assignee", null, new Constraint(ConstraintType.User, new org.bson.Document("multi", true).append("externalUsers", true)), null, null, null, 0, null),
            new Attribute("a2", "Due date", null, new Constraint(ConstraintType.DateTime, new org.bson.Document("format", "DD/MM/YYYY H:mm:ss")), null, null, null, 0, null),
            ...
            new Attribute("a4", "Observers", null, new Constraint(ConstraintType.User, new org.bson.Document("multi", true).append("externalUsers", true)), null, null, null, 0, null),
            new Attribute("a5", "Something", null, null, null, null, null, 0, null)
      ));
