...
public class ProjectFacade {
   ...
   public Map<String, String> readProjectsMap(final String organizationId) {
      ...
      documents.forEach(d -> projectsMap.put(d.getString(Project.ATTR_PROJECT_ID), d.getString(Project.ATTR_PROJECT_NAME)));
      return projectsMap;
   }
    ...
    */
   public void dropDocumentMetadata(final String projectId, final String metaName) {
   ...
   public Map<String, List<String>> readRoles(final String projectId) {
      ...
      documents.forEach(d -> userRoles.put(d.getString(Project.UserRoles.ATTR_USER_ROLE), d.getArrayList(Project.UserRoles.ATTR_CORE_ROLES, String.class)));
      return userRoles;
   }
   ...
   public Map<String, List<String>> readUsersRoles(final String projectId) {
      ...
      users.forEach(d -> usersRoles.put(d.getString(Project.ATTR_USER), d.getArrayList(Project.ATTR_USER_ROLES, String.class)));
      return usersRoles;
   }
