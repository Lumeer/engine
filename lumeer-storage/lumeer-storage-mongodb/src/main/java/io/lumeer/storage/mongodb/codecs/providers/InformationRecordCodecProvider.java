...
public class InformationRecordCodecProvider implements CodecProvider {

   @Override
   public <T> Codec<T> get(final Class<T> clazz, final CodecRegistry registry) {
      if (clazz == InformationRecord.class) {
         return (Codec<T>) new InformationRecordCodec(registry);
      }
